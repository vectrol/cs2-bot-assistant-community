...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::official_site::official_site_show,
            commands::official_site::official_site_navigate,
            commands::official_site::official_site_set_bounds,
            commands::official_site::official_site_hide,
            commands::official_site::official_site_reload,
            commands::official_site::official_site_go_back,
            commands::official_site::official_site_go_forward,
            ...
            commands::cs2::get_player_cosmetics_state,
            commands::cs2::save_player_cosmetics_state,
            commands::cs2::get_drop_knives_state,
            commands::cs2::save_drop_knives_state,
            commands::cs2::get_bot_items_state,
            commands::cs2::set_bot_items_state,
            commands::cs2::get_plus_runtime_status,
