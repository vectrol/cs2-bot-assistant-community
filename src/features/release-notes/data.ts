...
export const releaseNoteEntries: ReleaseNoteEntry[] = [
  {
    ...
    summary: '全新仪表盘主页，精简单栏导航，库存模拟器完整页面重做，所有 UI 布局现代化。',
    items: [
      { text: '全新仪表盘主页：卡片式导航，快速访问各功能模块，实时显示状态摘要。' },
      { text: '侧栏精简：图标+文字导航，支持折叠/展开，移除冗余描述。' },
      { text: '标题栏优化：非仪表盘页面显示返回按钮，操作按钮移至标题栏。' },
      { text: '库存模拟器大改：功能卡片网格展示六大特性，底部显示配置项。' },
      { text: '全局 UI 现代化：统一间距、圆角、色彩系统，更简洁干净。' },
    ],
  },
  {
    version: '1.3.1',
