...
export const releaseNoteEntries: ReleaseNoteEntry[] = [
  ...
  },
  {
    ...
    summary:
      '本次新增设置页面，把主题切换、官网入口、储存说明、自启动和首次自动安装集中到一起，同时移除 Major 预测页面，让程序更专注于 CS2 人机增强安装和控制。',
    items: [
      { text: '新增设置页面，集中管理外观主题、官网入口和程序行为。' },
      { text: '外观主题切换移动到设置页，深色和亮色模式仍会记住上次选择。' },
      { text: '新增官网入口，可从设置页打开 CS2 人机增强助手官网。' },
      { text: '新增官网意见页，可以在程序内访问 CS2AS 官网和意见区。' },
      { text: '官网页限制在 cs2as.600318.xyz 内访问，避免误跳到其他网站。' },
      { text: '登录状态会随内置 WebView 保存，下次打开程序会尽量保持登录。' },
